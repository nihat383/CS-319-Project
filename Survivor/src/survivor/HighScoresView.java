...
public class HighScoresView extends javax.swing.JPanel {
     ...
     */
    public HighScoresView(JFrame container) {
        initComponents();
        this.container = container;
        ArrayList<HighScore> scores = Util.getScores();
        for(int i = 0;i<scores.size();i++) {
            HighScore current = scores.get(i);
            jList1.add(new JLabel(current.getName() + "--->" + current.getScore()));
        }
    }
